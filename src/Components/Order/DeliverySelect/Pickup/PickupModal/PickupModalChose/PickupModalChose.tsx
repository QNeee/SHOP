...
export const PickupModalChose: FC<IPickupModalChose> = ({ items, text, id, setModal, setChange }) => {
                ...
                {isOpen && (
                    <>
                        <SelectContainerFlex style={{ marginTop: "10px" }}>
                            <PickupModalChoseInput onChange={(e) => setValue(e.currentTarget.value)} placeholder="Введіть адресу або номер відділення" />
                        </SelectContainerFlex>
                        <PickupModalChoseSelect setChange={setChange} setModal={setModal} items={filteredItems} />
                    </>
